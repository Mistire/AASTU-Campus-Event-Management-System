...
const PREMIUM_CATEGORIES = [
  {
    ...
    desc: "Workshops, Hackathons & Modern Tech",
  },
  {
    name: "Social & Fun",
    icon: Users2,
    color: "from-pink-500 to-rose-500",
    desc: "Parties, Mixers & Hangouts",
  },
  {
    name: "Academic",
    icon: Microscope,
    color: "from-amber-500 to-orange-500",
    desc: "Research, Seminars & Study",
  },
  {
    name: "Sports & Fit",
    icon: Trophy,
  ...
  },
  {
    ...
    desc: "Exhibitions & Workshops",
  },
  {
    name: "Career",
    icon: Zap,
    color: "from-indigo-500 to-blue-500",
    desc: "Jobs, Networking & Future",
  },
  {
    name: "Music & Vibe",
    icon: Music2,
    color: "from-red-500 to-orange-500",
    desc: "Concerts, Open Mic & DJ",
  },
  {
    name: "Photography",
    icon: Camera,
    color: "from-sky-500 to-cyan-500",
    desc: "Shots, Edits & Galleries",
  },
  {
    name: "Startups",
    icon: Rocket,
    color: "from-lime-500 to-green-500",
    desc: "Ideas, Pitching & Growth",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center justify-center min-h-screen pt-12 pb-24">
        ...
        >
          <Search
            className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-brand transition-colors"
            size={20}
          />
          <input
            type="text"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {isLoadingCategories ? (
              ...
              filteredCategories.map((category, idx) => {
                ...
                const meta =
                  PREMIUM_CATEGORIES[idx % PREMIUM_CATEGORIES.length];
                  ...
                  >
                    ...
                    <Icon
                      className={cn(
                        ...
                        isSelected
                          ? "text-brand/10 scale-110 rotate-12"
                          : "text-gray-100 -rotate-12",
                      )}
                    />
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                {selectedIds.length > 0 ? (
                  Array.from({ length: Math.min(3, selectedIds.length) }).map(
                    (_, i) => (
                      <div
                        key={i}
                        className="w-10 h-10 rounded-full border-2 border-white bg-brand flex items-center justify-center text-white"
                      >
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                  {selectedIds.length < 3
                    ? `Need ${3 - selectedIds.length} more`
                    : "Ready to launch"}
                </p>
              </div>
            </div>
