...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex bg-gray-100 dark:bg-background min-h-screen font-sans">
            ...
            <aside
                className={cn(
                    "fixed inset-y-0 left-0 z-50 bg-white dark:bg-gray-900 border-r border-gray-100/50 dark:border-gray-800 shadow-[20px_0_40px_rgba(0,0,0,0.02)] transition-all duration-500 md:translate-x-0 outline-none",
            ...
            <div className={cn(
                ...
                <header className="sticky top-0 z-40 flex h-20 items-center bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-6 md:px-10 transition-all duration-300">
                    <Button
                        variant="ghost"
                        size="icon"
                        className="mr-6 md:hidden text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all active:scale-95"
