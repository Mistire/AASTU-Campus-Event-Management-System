    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-10 pr-4 py-3.5 rounded-2xl border border-gray-100 bg-gray-50/50 text-sm font-medium text-gray-900 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand/30 transition-all"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-10 pr-12 py-3.5 rounded-2xl border border-gray-100 bg-gray-50/50 text-sm font-medium text-gray-900 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand/30 transition-all"
            />
            <button
              type="button"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="group relative w-full flex items-center justify-center gap-3 bg-brand hover:bg-brand-hover text-white font-brand font-black text-[10px] uppercase tracking-[0.15em] py-4 rounded-2xl shadow-xl shadow-brand/20 transition-all disabled:opacity-70 overflow-hidden mt-2"
        >
