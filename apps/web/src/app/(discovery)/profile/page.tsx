...
import { User, Mail, ShieldCheck, MapPin, Phone, Edit2, Camera, LogOut, Calendar, GraduationCap } from "lucide-react";
      ...
      <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group">
        ...
        <div className="flex-1 text-center md:text-left space-y-2 relative z-10">
          <div className="flex flex-col md:flex-row md:items-center gap-3">
            <h1 className="text-4xl font-black tracking-tighter text-gray-900">{profile?.full_name || "Student"}</h1>
        ...
        <div className="flex gap-3 relative z-10">
          ...
          <Button 
            className="rounded-2xl bg-red-50 border-red-100 text-red-500 font-black uppercase tracking-widest text-[10px] h-12 px-6 shadow-xl shadow-red-100/50 hover:bg-red-100 hover:text-red-500 transition-all border"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white p-8 rounded-xl border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="space-y-4 pt-2">
                <StatusRow icon={ShieldCheck} label="Identity Verified" value="YES" active />
                <StatusRow icon={GraduationCap} label="Academic Status" value="ACTIVE" active />
        ...
        <div className="lg:col-span-2 bg-white p-8 rounded-xl border border-gray-100 shadow-sm space-y-6 overflow-hidden relative group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 relative z-10">
                ...
                <InfoItem icon={MapPin} label="Campus Location" value="Main Campus" />
            </div>
        </div>
