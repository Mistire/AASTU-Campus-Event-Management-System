...
export function ModalHeader({ title }: ModalHeaderProps) {
  return (
    <div className="bg-brand px-8 py-6 flex items-center justify-between text-white rounded-t-[2rem] shrink-0 border-b border-white/10 relative overflow-hidden">
