      ...
      <div className="relative flex overflow-x-hidden group">
        ...
        >
          {doubledTestimonials.map((t, i) => (
            <div
              key={i}
              className="w-[420px] shrink-0 p-10 bg-white/40 backdrop-blur-3xl rounded-lg border border-white/40 shadow-2xl transition-all duration-500 hover:shadow-brand/10 hover:border-brand/20 hover:-translate-y-2 group/card flex flex-col justify-between relative overflow-hidden"
            >
              {/* Card Meta Log */}
              ...
              <div className="flex items-center gap-5">
                <div className="relative w-16 h-16 rounded-lg overflow-hidden shadow-lg border-2 border-white ring-4 ring-brand/5">
                  <Image
                    src={t.img}
                    alt={t.name}
                    fill
